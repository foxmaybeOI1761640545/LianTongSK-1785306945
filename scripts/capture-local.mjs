...
try {
  for (const [width, height] of [[1920, 1080], [1600, 900], [1366, 768]]) {
    ...
    await page.goto('http://127.0.0.1:4180/LianTongSK-1785306945/', { waitUntil: 'networkidle' })
  ...
  await detailPage.goto('http://127.0.0.1:4180/LianTongSK-1785306945/', { waitUntil: 'networkidle' })
